...
import { detailCategory } from '@/services/categoryService.js'
...
onMounted(async () => {
  category.value = await detailCategory(route.params.id)
  tours.value = category.value.tours
})
</script>
<style scoped>
